...
(function (global) {
  ...
  const FORA = [
    ...
    'current',
    'historico',
    // AS DUAS DO CLONE PELA REDE, que saiu na v1.8.16. Elas FICAM na lista, e
    // isso não é resíduo: são chaves ÓRFÃS em todo aparelho que chegou a usar
    // o recurso, e tirá-las daqui faz lixo começar a viajar no `.avpkg`. Elas
    // descreviam o que aconteceu NAQUELE celular — a mesma razão do
