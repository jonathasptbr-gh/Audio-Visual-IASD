...
// A BÍBLIA BASE DO APP, baixada sozinha na abertura (v5.241)
//
...
async function ensureBibleVersionDownloaded(versionId) {
  ...
  // na abertura (`garantirBibliaBase`, v5.241) o cenário mudou — um lançamento
...
(async function init() {
  ...
  autoRefreshCollections();
  // A BÍBLIA BASE, garantida sozinha (v5.241) — metadados e, atrás deles, a
