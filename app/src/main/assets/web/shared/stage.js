...
(function (global) {
  ...
  function createStage(opts) {
    ...
    // (v1.7.3). Relato do operador: *"ao encerrar o tempo de uma música, a
    ...
    async function marcarFimNatural() {
      ...
      if (seq !== loadSeq) return;
      ended = true;
      // PAUSA EXPLÍCITA, e ela só importa para o chamador DE FORA (v1.7.3): no
    ...
    return {
      ...
      // O FIM DA PROJEÇÃO É UM FIM, E NÃO UMA PAUSA (v1.7.3). Quem sabe que a
