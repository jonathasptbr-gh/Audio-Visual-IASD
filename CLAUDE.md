...
- **UMA LINGUAGEM DE ESTADO SÓ, e ela responde a quatro perguntas.** O app
  ...
  **E NA GRADE DE CONFIGURAÇÕES A REGRA VIROU ABSOLUTA** (v1.7.5): nenhum tile
...
> **A COR NÃO DIZ ESTADO NENHUM** (v1.7.5). Pedido do operador: *"O botão do
...
> (v1.7.5). Pedido: *"use um icone de picture, paisagem. O próprio quadro vai
...
> **A ORDEM DA GRADE PASSOU A SER POR ASSUNTO** (v1.7.5): *"reordene os botões:
...
**O LOTE ANTERIOR (v1.7.4) — a linha que sai, o botão que cancela, e o bloco
que não encolhe:**
...
> **E ANTES DELE A v1.7.2 — três pedidos, e o terceiro é um defeito com
> relato:**
