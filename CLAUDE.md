...
window.AVNative = {
  ...
  bgProgress({label, done, total, etaMs, items, idleMs, bytes, icone}), // progresso
                       ...
                       //   (um bitmap desenhado por atualização) e a v1.8.33
...
**Versão atual: base web v1.8.33 · APK v1.8.33** · `SHELL_VERSION` **71** ·
bundle com `minShell: 71` e **`shellTag: "v1.8.33"`** (lote COM Release) — o
...
**O QUE O LOTE TRAZ (v1.8.33) — a seta volta a se mexer:**
...
> **UM ÍCONE DE BARRA OU ANDA OU DIZ UM NÚMERO, NUNCA OS DOIS** (v1.8.33).
