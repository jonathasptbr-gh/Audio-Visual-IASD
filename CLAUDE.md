...
- **O DIÁLOGO SAIU, E A INFORMAÇÃO DELE NÃO.** Ele dizia duas coisas: o
  ...
  desde a v1.7.6.
- **O TOQUE LONGO SAIU, E O IRMÃO O SUBSTITUI** (v1.8.28). Ele existiu da
...
- **A IMPORTAÇÃO NÃO RECARREGA MAIS O APP** (v1.8.28). Ela terminava em
...
**Versão atual: base web v1.8.28 · APK v1.8.28** · `SHELL_VERSION` **70** ·
bundle com `minShell: 70` e **`shellTag: "v1.8.28"`** (lote COM Release) — o
...
**O QUE O LOTE TRAZ — o arquivo consumido, a seta certa e o app que não
recarrega:**
...
> **A SETA É DIREÇÃO DE BYTES, NÃO PROCEDÊNCIA DELES** (v1.8.28). Pedido do
...
> **E A RECARGA DO FIM DA IMPORTAÇÃO SAIU** (v1.8.28), com o argumento que a
