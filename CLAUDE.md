...
teto de sessões e saneamento. **E a REGRA DA DERIVA DO SOM** desde a v5.184
...
> **A v5.184 (v1.74): O EIXO DO SOM ERA UM LAÇO ABERTO — "o som fica para trás,
...
> som. Ver `docs/ESPELHO-DE-PIXELS.md` §10-A.12.
