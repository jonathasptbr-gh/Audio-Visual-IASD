...
**O LOTE ANTERIOR (v1.7.2) — três pedidos, e o terceiro é um defeito com relato:**
...
> **E O ANTERIOR A ELE (v1.7.1)** trouxe a legenda do trabalho para a posição do
...
> byte nenhum). A barra que ele desenhou ao lado da frase saiu na v1.7.3, a
