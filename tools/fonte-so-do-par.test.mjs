...
const testemunha = () => pg.evaluate(() => {
  ...
  // A GAVETA DA VELOCIDADE entrou na testemunha na v1.7.2: o toque no botão de
...
// remontagem.
// `:not(.lv-cifra-vel-op)` exclui os botões da GAVETA da velocidade (v1.7.2), e
...
try {
  ...
  for (const caminho of ['click()', 'dedo na borda', 'teclado (Enter)']) {
    ...
    for (let i = 0; i < alvos.length; i++) {
      ...
      //
      // E A GAVETA DA VELOCIDADE TAMPOUCO (v1.7.2), e esta metade não é
  ...
  // ========================================================================
  // BLOCO 1-B — E OS BOTÕES DA GAVETA DA VELOCIDADE (v1.7.2)
  // ========================================================================
  //
