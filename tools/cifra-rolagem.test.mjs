...
try {
  ...
  //
  // ===== A GAVETA SUBSTITUIU O CARROSSEL (v1.7.2) =====
  //
  ...
  const escada = await pg.evaluate(() => {
    ...
    const ctlAntes = ctl();
    // A CAIXA, degrau a degrau. A escada é percorrida pela GAVETA agora (v1.7.2)
  ...
  // ===== O PEDIDO DA v1.7.2, nas duas metades =====
  ...
  // ===== E A GAVETA ABERTA CABE NA MESMA FILA (v1.7.2) =====
  //
