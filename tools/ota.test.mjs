...
//
// E, desde a v5.243 (o segundo relato do operador sobre este mesmo fluxo):
//
...
try {
  ...
  // ── 4. "DEIXAR PARA DEPOIS" cala o diálogo, não o FATO ───────────────────
  {
    ...
    // Desde a v5.243 quem carrega esse fato é o BOTÃO, por extenso, e não mais
  ...
  // operador que voltou para pedir a atualização de propósito. Antes da v5.243
  ...
  // ── 4c. O DIÁLOGO NÃO SE PERDE NUM TOQUE FORA (v5.243) ───────────────────
  //
