...
const PONTE = `(() => {
  ...
  // desde a v1.7.3 e 720p, entao e este o caminho normal), ytFetch sem teto e
...
try {
  ...
  // (6. O SUBTEXTO do "Tocar agora" com "Online" — removido na v1.7.3.)
  //
  ...
  const nomeDoCartao = await pg.evaluate(async () => {
    ...
    // O ESPIÃO DO REGISTRO É O DO DOWNLOAD (v1.7.3): era o `addStreamMedia`, e
