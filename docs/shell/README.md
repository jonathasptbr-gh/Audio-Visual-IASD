...
| arquivo | linhas | onde |
|---|---|---|
| `NativeBridge.kt` | 1.786 | [`PONTE.md`](PONTE.md) |
| `WebViewFactory.kt` | 323 | [`PONTE.md`](PONTE.md) — invariantes 1-4 |
| `SafPathHandler.kt` | 99 | [`PONTE.md`](PONTE.md) — o token `/saf/` |
| `WebUpdater.kt` | 1.184 | [`OTA.md`](OTA.md) |
| `ShellUpdater.kt` | 350 | [`OTA.md`](OTA.md) |
...
| `EspelhoMidiaCanal.kt` | 217 | idem |
| `EspelhoEnergia.kt` | 348 | idem |
| `EspelhoCert.kt` | 298 | idem (TLS opcional; **sem UI desde a v5.196**) |
| `EspelhoDiag.kt` | 135 | idem |
| `YoutubeGrab.kt` | 1.991 | `CLAUDE.md` — "Trabalho em segundo plano" e "Divergências" |
...
| `SessionService.kt` | 980 | `CLAUDE.md` — "Notificação de controles" |
| `SyncService.kt` | 545 | `CLAUDE.md` — "Trabalho em segundo plano" |
...
| `ShareIntake.kt` | 164 | `CLAUDE.md` — "Compartilhamento" |
...
| `NucleoServidor.kt` **(:core)** | 377 | [`../SEGUNDA-CASCA.md`](../SEGUNDA-CASCA.md) — o socket de loopback; **a porta é a origem** |
| `NucleoPonte.kt` **(:core)** | 274 | [`../SEGUNDA-CASCA.md`](../SEGUNDA-CASCA.md) — o **envelope** da ponte (PURO); três escritas, uma fixture |
| `NucleoDespacho.kt` **(:core)** | 261 | [`../SEGUNDA-CASCA.md`](../SEGUNDA-CASCA.md) — quem responde o quê; **a invariante 9 com oráculo** |
