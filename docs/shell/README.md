...
> (`app/src/main/java/br/org/iasd/av/`, 30 arquivos). As regras que valem para
...
## Os 30 arquivos, e onde cada um é explicado
...
| `MainActivity.kt` | 2.313 | `CLAUDE.md` — voltar, volume, cast, fullscreen |
