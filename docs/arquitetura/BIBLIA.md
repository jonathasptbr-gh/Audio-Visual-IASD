...
**A GRADE DE LIVROS TEM PISO, E ROLA EM VEZ DE CORTAR (v1.7.11).** Ela era
...
`flex-wrap`" até a v1.7.11, uma versão inteira depois de a v1.7.10 acrescentar
o `flex-wrap`.)*
...
dois lugares —, **com um `min-height: var(--hit)` embaixo (v1.7.11)**: quando a
