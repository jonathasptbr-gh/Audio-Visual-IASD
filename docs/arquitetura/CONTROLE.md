...
**E ELA SAIU DE DENTRO DO SCROLLER** (v1.8.97). Relato do operador: *"o texto de
...
**E O RECIBO CALADO NÃO OCUPA NADA** (`.sorteio-fala:empty`, v1.8.97) — MEDIDO,
...
- **O TOQUE NUM NÚMERO À VISTA** (v1.8.97): *"está no 1, mas eu vejo o 3. Se eu
...
- **REABRIR REINICIA OS FILTROS** (v1.8.97), a pedido do operador: *"reinicie
