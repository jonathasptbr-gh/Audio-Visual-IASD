...
> **O ANÚNCIO DE ESPERA DO PALCO (`opts.onEspera`) SAIU NA v1.8.80.** Ele existia
...
> v1.8.80.** A regra abaixo NÃO saiu com ela: ela vale para **toda** resposta
...
O que o `StreamProxy` responde (KOTLIN; sem cliente no web desde a v1.8.80):
