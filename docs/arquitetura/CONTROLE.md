...
| [Buscar no YouTube](#pesquisar-texto-no-youtube-no-fim-da-busca) | busca e download (a transmissão direta saiu na v1.7.6) |
...
> **NADA NO APP CRIA UM STREAM DESDE A v1.7.6** — a transmissão direta saiu a
...
- **(A transmissão direta SAIU na v1.7.6.** Ela ficava de fora quando havia um
...
- **O NOME DO APP VENCE O TÍTULO DO YOUTUBE** (v1.4.10), nos DOIS caminhos —
  o caminho da transmissão (`r.name || man.name`, removido na v1.7.6) e `ytBaixarNativo`
