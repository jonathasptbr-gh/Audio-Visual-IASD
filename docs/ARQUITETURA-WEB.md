...
**E NA v5.248 O BOTÃO DAQUI SAIU TAMBÉM**, substituído por uma **engrenagem**
...
- **Configurações** (`#simpleSettingsBtn`), no cabeçalho — e é por ela que se
  volta ao avançado desde a v5.248. **Sem TV o app não fica
