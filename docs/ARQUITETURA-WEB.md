...
**As duas linhas que ESCONDIAM a alça e a estrela saíram na v5.257**, e o
...
#### Os botões da linha viram UM SÓ (o `⋮`, v5.257)
...
#### Os favoritos se atualizam com a Biblioteca ABERTA (v5.257)
...
1. **Os itens marcados** (`favItemRow`), na ordem da lista `favs`, que é a
   ...
   três últimas moram **dentro do `⋮`** desde a v5.257 (ver "Os botões da linha
...
de uma linha (`dotsIconSvg`, v5.257 — `more_vert` não está no subset), o
