...
- **v5.302** — A PLAYLIST AUTOMÁTICA: sortear por tema, uma só ou uma fila — e a regra é um arquivo PURO com dois oráculos. OTA PURO
...
**A v5.302: A PLAYLIST AUTOMÁTICA — sortear por tema, uma só ou uma fila, e a
